...
def solve(num_wizards, num_constraints, wizards, constraints,alternate):
    """
    Write your algorithm here.
    Input:
        num_wizards: Number of wizards
...
###TEST
    ...
    #     cycle = False
###ENDTEST
    #altsoln = solve2(num_wizards, num_constraints, wizards, constraints, zakiOrder)
